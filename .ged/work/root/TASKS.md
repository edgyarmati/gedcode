...
| ORCH-TIER-03 | NEXT | Build the non-skippable Orchestrator migration wizard with harness/model/thinking pickers for all three presets and project overrides. | Chromium proves direct-route/deep-link blocking, validation, completion, restart persistence, and restored access. |
