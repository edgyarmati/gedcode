...
| ORCH-WORK-03 | NEXT | Add scoped PM/MCP tools to inspect task status/diff and commit, discard, or return/steer remaining changes. Invalidate prior verification after every mutation. | Tool tests reject foreign paths/tasks, preserve selected hunks, record descriptive commits, and prove discard/return outcomes. |
