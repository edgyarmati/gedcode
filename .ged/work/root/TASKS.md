...
| ORCH-WORK-02 | NEXT | Detect dirty tracked/untracked files when a work turn settles; re-enter the PM exactly once and prevent verify startup until resolution. Require work-agent commits in stage instructions. | Integration tests cover dirty, clean committed, clean no-change, restart, duplicate settlement, and verification rejection. |
