...
| ORCH-TIER-04 | NEXT | Replace per-role backend settings with polished preset cards showing harness logo, model, and thinking; retain advanced role prompt prefixes separately. | Settings logic/Chromium cover global defaults, project inheritance/override/reset, logos, and option reconciliation. |
