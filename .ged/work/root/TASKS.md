...
| CHAT-FORK-02 | NEXT | Add **Continue in new task** only to completed assistant-message actions, call the typed fork operation, and navigate to the new task. | Browser test verifies visibility boundaries, pending/error states, successful creation/navigation, and unchanged source history. |
