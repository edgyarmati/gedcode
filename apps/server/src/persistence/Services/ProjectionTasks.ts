...
export const ProjectionTask = Schema.Struct({
  ...
  changeReview: Schema.NullOr(OrchestrationTaskChangeReview),
  verification: Schema.NullOr(OrchestrationTaskVerification),
  noChangesNeeded: Schema.NullOr(OrchestrationTaskNoChangesNeeded),
  landing: Schema.NullOr(OrchestrationTaskLanding),
  forceLandRequest: Schema.NullOr(OrchestrationTaskForceLandRequest),
