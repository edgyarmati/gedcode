...
import Migration0047 from "./Migrations/047_ProjectionTaskLanding.ts";
...
import Migration0052 from "./Migrations/052_ProjectionTaskSplitDetails.ts";
import Migration0053 from "./Migrations/053_ProjectionTaskReleaseDispatch.ts";
import Migration0054 from "./Migrations/054_RemoveLegacyOrchestrationRoleSettings.ts";
import Migration0055 from "./Migrations/055_RemoveLegacyOrchestrationStageHistory.ts";
import Migration0056 from "./Migrations/056_ProjectionTaskCompletionRecords.ts";
import Migration0057 from "./Migrations/057_ProjectionStageCapabilityPreset.ts";
import Migration0058 from "./Migrations/058_ProjectionTaskCapabilityTiers.ts";
import Migration0059 from "./Migrations/059_ProjectionHelperRuns.ts";
import Migration0060 from "./Migrations/060_ProjectionProjectContextOnboarding.ts";
import Migration0061 from "./Migrations/061_ProjectionProjectContextRuns.ts";
...
import Migration0070 from "./Migrations/070_ProjectionStageHistoryNetworkAccess.ts";
...
export const migrationEntries = [
  ...
  [47, "ProjectionTaskLanding", Migration0047],
  ...
  [52, "ProjectionTaskSplitDetails", Migration0052],
  [53, "ProjectionTaskReleaseDispatch", Migration0053],
  [54, "RemoveLegacyOrchestrationRoleSettings", Migration0054],
  [55, "RemoveLegacyOrchestrationStageHistory", Migration0055],
  [56, "ProjectionTaskCompletionRecords", Migration0056],
  [57, "ProjectionStageCapabilityPreset", Migration0057],
  [58, "ProjectionTaskCapabilityTiers", Migration0058],
  [59, "ProjectionHelperRuns", Migration0059],
  [60, "ProjectionProjectContextOnboarding", Migration0060],
  [61, "ProjectionProjectContextRuns", Migration0061],
  ...
  [70, "ProjectionStageHistoryNetworkAccess", Migration0070],
