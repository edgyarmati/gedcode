...
const pmSystemPrompt = (driverKind: ProviderDriverKind): string =>
  [
    ...
    "Verification remains independent: never steer a verifier to repair implementation. If Verify finds a code defect, give the findings to Work, then start a fresh Verify after the fix settles. Do not continue an old Work thread after a newer stage has taken ownership; that correction is a new Work attempt.",
