...
export const SidebarSurfaceSwitch = memo(function SidebarSurfaceSwitch() {
  ...
  return (
    <div className="shrink-0 px-2 py-2">
      <div
        ...
        data-testid="sidebar-surface-switch"
      >
        <span
          aria-hidden
          ...
          style={{ transform: showOrchestratorMode ? "translateX(100%)" : undefined }}
        />
        {(["chat", "orchestrator"] as const).map((surface) => {
          const selected =
            surface === "orchestrator" ? showOrchestratorMode : !showOrchestratorMode;
          return (
            <button
              key={surface}
              ...
              type="button"
              onClick={() => {
                if (!selected) handleModeClick();
              }}
            >
              {surface === "chat" ? "Chat" : "Orchestrator"}
            </button>
          );
        })}
      </div>
...
const SidebarProjectsContent = memo(function SidebarProjectsContent(
  ...
  return (
    <SidebarContent className="gap-0">
      ...
      {showDesktopUpdateAction ? (
        <SidebarGroup className="px-2 pt-2 pb-0">
          <Alert variant="info" className="rounded-2xl border-primary/30 bg-primary/8">
            <CloudIcon />
...
export default function Sidebar() {
  ...
  const arm64IntelBuildWarningDescription =
    desktopUpdateState && showArm64IntelBuildWarning
      ...
      : null;
  const showDesktopUpdateAction =
    !showArm64IntelBuildWarning && shouldShowDesktopUpdateButton(desktopUpdateState);
  ...
  return (
    <>
      ...
      {!isOnSettings ? <SidebarSurfaceSwitch /> : null}
      ...
      {isOnSettings ? (
        ...
        <>
          <SidebarProjectsContent
            ...
            showDesktopUpdateAction={showDesktopUpdateAction}
