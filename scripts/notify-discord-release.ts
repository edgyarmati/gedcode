  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new GedCode prerelease is available for nightly testers."
          : "A new GedCode latest release is available.",
...
).pipe(Command.withDescription("Post a GedCode release announcement to Discord."));
