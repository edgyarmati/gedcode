...
GED projects use one canonical project context at the repository root:
...
Do not create or follow `CONTEXT-MAP.md`, nested context glossaries, or nested ADR directories. GED's
canonical context files are root `CONTEXT.md` and root `docs/adr/`.
