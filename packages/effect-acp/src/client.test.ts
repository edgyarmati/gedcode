...
// These tests spawn a real Bun peer. GitHub Actions can starve child-process startup
// while the monorepo test suite runs in parallel, so keep the integration timeout
// above Vitest's 5s unit-test default without changing the assertions under test.
