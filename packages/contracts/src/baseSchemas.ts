...
export const HelperRunId = makeEntityId("HelperRunId");
export type HelperRunId = typeof HelperRunId.Type;
export const ProjectContextRunId = makeEntityId("ProjectContextRunId");
export type ProjectContextRunId = typeof ProjectContextRunId.Type;
export const GateId = makeEntityId("GateId");
